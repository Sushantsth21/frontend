...
import { Upload, FileText, AlertCircle, CheckCircle, Loader2, Download, X, ClipboardList, Plus, Activity, Image } from 'lucide-react';
...
const FormEntry = () => {
  ...
  const description = "Upload medical forms and documents. Our intelligent system will digitize and structure your form data efficiently.";
  ...
  if (!API_BASE_URL) {
    console.error('NEXT_PUBLIC_API_URL environment variable is not set. Please check your .env.local file.');
  }
        ...
        {files.length === 0 && (
          <div className="text-center py-16 flex-1 flex flex-col justify-center">
            ...
            <p className="text-slate-500 max-w-sm mx-auto leading-relaxed">
              Drag and drop your files here or click the browse button to get started.
            </p>
          </div>
        )}
      </div>
